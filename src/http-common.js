...
export default axios.create({
    ...
    baseURL: "https://radoslaw-sawicki-backend-react-e34897bc6a9c.herokuapp.com/api",
    headers: {
...
export const BASE_URL = "https://radoslaw-sawicki-backend-react-e34897bc6a9c.herokuapp.com/api";
